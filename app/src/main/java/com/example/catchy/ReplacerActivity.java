...
import com.example.catchy.fragments.Comment;
import com.example.catchy.fragments.CreateAccountFragment;
import com.example.catchy.fragments.LoginFragment;
...
public class ReplacerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else setFragment(new LoginFragment());
